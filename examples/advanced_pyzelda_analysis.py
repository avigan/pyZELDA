...
mappable = ax.imshow(clear_pupil, aspect='equal', vmin=0, vmax=1, origin=1)
...
ax.imshow(zelda_pupil, aspect='equal', vmin=0, vmax=1, origin=1)
ax.set_title('ZELDA pupil')

ax = fig.add_subplot(gs[0,3])
ax.imshow(aberration*1e9, aspect='equal', vmin=-40, vmax=40, cmap='magma', origin=1)
ax.set_title('Introduced aberration (nm)')

ax = fig.add_subplot(gs[0,4])
cax = ax.imshow(z_opd_standard, aspect='equal', vmin=-40, vmax=40, cmap='magma', origin=1)
ax.set_title('Reconstructed aberration - standard')

ax = fig.add_subplot(gs[0,5])
cax = ax.imshow(z_opd_advanced, aspect='equal', vmin=-40, vmax=40, cmap='magma', origin=1)
